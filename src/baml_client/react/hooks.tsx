...
/**
 * A specialized hook for the ChatWithLLM BAML function that supports both streaming and non‑streaming responses.
 *
 * **Input Types:**
 *
 ...
 *
 * **Return Type:**
 * - **Non‑streaming:** AssistantResponse
 * - **Streaming Partial:** partial_types.AssistantResponse
 * - **Streaming Final:** AssistantResponse
 *
 * **Usage Patterns:**
 ...
 * const { data, error, isLoading, mutate } = useChatWithLLM({ stream: false});
 *
 * // Streaming usage:
 * const { data, streamData, isLoading, error, mutate } = useChatWithLLM({
 ...
 * ```
 */
export function useChatWithLLM(props: HookInput<'ChatWithLLM', { stream: false }>): HookOutput<'ChatWithLLM', { stream: false }>
export function useChatWithLLM(props?: HookInput<'ChatWithLLM', { stream?: true }>): HookOutput<'ChatWithLLM', { stream: true }>
export function useChatWithLLM(
  props: HookInput<'ChatWithLLM', { stream?: boolean }> = {},
): HookOutput<'ChatWithLLM', { stream: true }> | HookOutput<'ChatWithLLM', { stream: false }> {
  let action = Actions.ChatWithLLM;
  if (isStreamingProps(props)) {
    action = StreamingActions.ChatWithLLM;
  }
